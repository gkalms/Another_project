...
},{}],"src/newFruit.js":[function(require,module,exports) {
"use strict";
...
var newFruit = function newFruit() {
  var categoryResponse = $.ajax({
    // this gets all data back from category document
    type: "GET",
    url: "api/fruits/category/all"
  }).done(function (fruitCategories) {
    // define a variable = optionhtml
    var optionsHtml = ""; // creates a for loop with values from the category

    fruitCategories.forEach(function (fruitEl) {
      ...
      optionsHtml += "<option value=".concat(fruitEl._id, ">").concat(fruitEl.name, "</option>");
    });
    $('#categories').append(optionsHtml);
  }); // form submit handler logic

  $(document).on("submit", "#form-fruit", /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 11:
              ...
              console.log("response", response); // Logging response back to the console
...
var _default = newFruit;
exports.default = _default;
},{"regenerator-runtime":"node_modules/regenerator-runtime/runtime.js"}],"src/user/newUser.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{}],"src/updateFruit.js":[function(require,module,exports) {
"use strict";
...
var updateFruit = function updateFruit() {
  // category logic
  var categoryResponse = $.ajax({
    type: "GET",
    url: "/api/fruits/category/all"
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return $.ajax({
                type: "PATCH",
                // OR GET
                url: "/api/fruits/update-fruit/".concat($("#fruitId").val()),
                contentType: "application/json",
                data: JSON.stringify(requestBody)
              });
...
var _default = updateFruit;
exports.default = _default;
},{}],"src/deleteFruit.js":[function(require,module,exports) {
"use strict";
...
var deleteFruit = function deleteFruit() {
  // category logic
  var categoryResponse = $.ajax({
    type: "GET",
    url: "/api/fruits/category/all"
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              console.log("requestBody", requestBody); // Making the call to delete request

              _context.next = 12;
              return $.ajax({
                type: "DELETE",
                url: "/api/fruits/delete-fruit/".concat($("#fruitId").val()),
                contentType: "application/json",
                data: JSON.stringify(requestBody)
              });
...
var _newFruit = _interopRequireDefault(require("./newFruit.js"));

var _newUser = _interopRequireDefault(require("./user/newUser"));

var _loginUser = _interopRequireDefault(require("./user/loginUser"));

var _updateFruit = _interopRequireDefault(require("./updateFruit"));

var _deleteFruit = _interopRequireDefault(require("./deleteFruit"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

console.log("Check if this works"); // $("body").prepend(newFruit());
// $("body").prepend(loginUser());
// $("body").prepend(updateFruit());

$("body").prepend((0, _deleteFruit.default)());
},{"regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","./newFruit.js":"src/newFruit.js","./user/newUser":"src/user/newUser.js","./user/loginUser":"src/user/loginUser.js","./updateFruit":"src/updateFruit.js","./deleteFruit":"src/deleteFruit.js"}],"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
